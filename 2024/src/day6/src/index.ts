...
const obstructionCoordinates : number[][] = []
const visitedPositions : number[][] = []
let guardStartingPostion : number[] = []
...
const isNotInObstructions = (x: number, y: number) => {
...
{   
    ...
    const uniquePositions = visitedPositions.filter((value, index, self) => 
